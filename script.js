/* ============================================================
   PORTAL: Capoeira e valentia em São Paulo
   JavaScript global
   ============================================================ */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const btnsFont = document.querySelectorAll('.btn-fonte');
  btnsFont.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      else if (nivel === 'n') { btn.classList.add('ativo'); }
      salvarPref();
    });
  });
  ...
  if (prefs.fonte === 'g')  { body.classList.add('fonte-g');  document.querySelector('[data-nivel=g]')?.classList.add('ativo'); }
  if (prefs.fonte === 'gg') { body.classList.add('fonte-gg'); document.querySelector('[data-nivel=gg]')?.classList.add('ativo'); }

  // --- HERO: imagem rotativa ---
  rotacionarHero();
});
